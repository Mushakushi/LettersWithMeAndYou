...
namespace Framework.SceneManagement.Runtime.ScriptableObjects.Channels
{
    /// <summary>
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "SceneEventChannel", menuName = "ScriptableObjects/Scene/Channels/Scene", order = 0)]
